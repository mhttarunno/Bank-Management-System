...
## Usage
1. Launch the application and log in as a bank administrator.  
2. Create or update customer accounts.  
3. Perform deposits, withdrawals, and transfers.  
4. View transaction history for each account.
